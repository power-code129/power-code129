...
- 🧠 **AI/ML** — sentiment analysis models (77–86% accuracy) during IBM internships
- 🔌 **Embedded/FPGA** — adaptive systolic array accelerator for edge AI, built in Xilinx Vivado
- 🚨 **IoT** — MediGuard, a medicine temperature-safety system built at a 36-hour national hackathon
- ☁️ **Cloud** — deployed this GitHub profile's portfolio on AWS S3, GCP Arcade facilitator, OCI certified
...
<div align="center">
<sub>📍 Coimbatore, Tamil Nadu, India &nbsp;·&nbsp; Open to opportunities across Software, Embedded, AI/ML, Cloud, and Technical PM roles</sub>
</div>
